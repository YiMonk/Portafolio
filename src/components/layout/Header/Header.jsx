...
export function Header({ setDarkMode, darkMode }) {
  return (
    <div className="h-10 px-50 flex justify-between items-center p-5 mb-15 ">
      <div className="flex gap-x-10 text-lg  font-normal hover:cursor-pointer  transition-all duration-200">
        <span
      ...
      <div
        className={
          "border border-gray-300 rounded-full px-6 py-2 hover:cursor-pointer hover:bg-gray-300 transition-colors duration-200 " +
